...
define( 'skylark-graphics-shapes/transform/Matrix',[
    "skylark-langx/langx",
    "../shapes",
], function(langx,shapes){
	// reference easeljs/shapes/Matrix2D  and dojox/gfx/matrix
    ...
    var Matrix = shapes.TransformMatrix = langx.klass({
...
define('skylark-graphics-shapes/transform/Transform',[
    "skylark-langx/langx",
    "../shapes",
	"./Matrix"
...
define('skylark-graphics-shapes/transform/MatrixTransform',[
    "skylark-langx/langx",
    "../shapes",
	"./Transform",
	"../Point",
...
define('skylark-graphics-shapes/transform/RotateTransform',[
    "skylark-langx/langx",
    "../shapes",
	"./Transform",
	"./Matrix",
...
define('skylark-graphics-shapes/transform/ScaleTransform',[
    "skylark-langx/langx",
    "../shapes",
    "./Transform",
    "./Matrix",
...
define('skylark-graphics-shapes/transform/SkewTransform',[
    "skylark-langx/langx",
    "../shapes",
    "./Transform",
    "./Matrix",
...
define('skylark-graphics-shapes/transform/TranslateTransform',[
    "skylark-langx/langx",
    "../shapes",
    "./Transform",
    "./Matrix",
